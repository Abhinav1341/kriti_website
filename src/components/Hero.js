        ...
        >
          ...
          >
            <div
              ...
              data-aos-delay="200"
            >
              <h1 className="mb-3 md:text-5xl text-3xl font-bold text-[#d45369]">
              ...
              <div className="mb-4 space-x-0 md:space-x-2 md:mb-8">
                <Link
                  to="/"
                  className="text-white bg-[#d36073] hover:bg-transparent inline-flex items-center border border-[#d36073] justify-center w-full px-6 py-3 my-4 text-lg shadow-xl rounded-2xl sm:w-auto sm:mb-0"
                >
                  Register Here
                  <svg
                ...
                <a
                  href="https://drive.google.com/file/d/151tDPwgb5YKRTS951qD2dfDxR9gPw-0p/view?usp=drive_link"
                  target="_blank"
                  className="text-white bg-transparent border border-[#d36073] hover:bg-[#d36073] hover:text-zinc-900 inline-flex items-center justify-center w-full px-6 py-3 my-4 text-lg shadow-xl rounded-2xl sm:w-auto sm:mb-0"
                >
                  Event Brochure
                  <svg
                    className="w-4 h-4 ml-1"
